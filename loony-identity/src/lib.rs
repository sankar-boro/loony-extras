...
use loony::http::error::HttpError;
use loony::http::header::{self, HeaderValue};
use loony::http::{HttpMessage, Payload};
use loony::service::{Service, Transform};
use loony::util::Extensions;
...
// ```rust
// use loony::web::App;
// use loony_identity::{CookieIdentityPolicy, IdentityService};
//
...
mod tests {
    ...
    use loony::service::into_service;
    ...
    async fn test_borrowed_mut_error() {
        ...
        use loony::web::{DefaultError, Error};
        ...
        let srv = IdentityServiceMiddleware {
            ...
            service: Rc::new(into_service(|_: WebRequest<DefaultError>| async move {
                loony::rt::time_driver::sleep(std::time::Duration::from_secs(100)).await;
        ...
        loony::rt::time_driver::sleep(std::time::Duration::from_millis(50)).await;
