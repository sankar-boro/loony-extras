...
use loony::http::{header, Method, Payload, Uri};
use loony::router::{ResourceDef, ResourcePath};
use loony::service::boxed::{self, BoxService, BoxServiceFactory};
use loony::service::{IntoServiceFactory, Service, ServiceFactory};
use loony::util::Bytes;
use loony::web::dev::{WebServiceConfig, WebServiceFactory};
use loony::web::{WebRequest, WebResponse};
use loony::web::error::ErrorRenderer;
use loony::web::guard::Guard;
use loony::web::{self, FromRequest, HttpRequest, HttpResponse};
...
mod tests {
    ...
    use super::*;
    use loony::http::{self, Method, StatusCode};
    use loony::web::middleware::Compress;
    use loony::web::test::{self, TestRequest};
    use loony::web::{guard, App, DefaultError};
